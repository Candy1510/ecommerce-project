...
const Toast = ({ toast }: { toast: ToastType }) => {
  ...
  return (
    <div
      className={`flex items-center gap-3 p-4 rounded-lg border shadow-lg ${getColors()} animate-slide-in`}
      role="alert"
    >
      ...
      <button
        ...
        className={`ml-auto flex-shrink-0 ${getTextColor()} hover:opacity-75`}
      >
